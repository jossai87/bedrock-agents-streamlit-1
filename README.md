...
- Download the Lambda funcion definition [here](https://raw.githubusercontent.com/ramiroao-dev/bedrock-agents-streamlit-1/main/lambda_function.zip).

- In the Lambda console, go to the "Code" tab, click "Upload from" → ".zip file", browse to select the downloaded lambda_function.zip, click "Upload".

![Create Function2](images/create_function3.png)
